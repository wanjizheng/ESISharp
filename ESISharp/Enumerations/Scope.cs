...
namespace ESISharp.Enumerations {
    ...
    public class Scope {
        ...
        internal Scope(string val) {
            ...
            if (val != string.Empty) Lookup.Add(val, this);
        }
        ...
        public static class Bookmarks {
            ...
            public static readonly Scope ReadCharacterBookmarks =
                new Scope("esi-bookmarks.read_character_bookmarks.v1");

            /// <summary>Read Corporation Bookmarks Scope</summary>
            public static readonly Scope ReadCorporationBookmarks =
                new Scope("esi-bookmarks.read_corporation_bookmarks.v1");
        }
        ...
        public static class Contracts {
            ...
            public static readonly Scope ReadCharacterContracts =
                new Scope("esi-contracts.read_character_contracts.v1");

            /// <summary>Read Corporation Contracts Scope</summary>
            public static readonly Scope ReadCorporationContracts =
                new Scope("esi-contracts.read_corporation_contracts.v1");
        }
        ...
        public static class Corporations {
            ...
            public static readonly Scope ReadCorporationMembership =
                new Scope("esi-corporations.read_corporation_membership.v1");
        ...
        public static class Killmails {
            ...
            public static readonly Scope ReadCorporationKillmails =
                new Scope("esi-killmails.read_corporation_killmails.v1");
