namespace ESISharp.Enumerations {
    ...
    public class SearchCategory {
        ...
        public static readonly SearchCategory All = new SearchCategory(
            "agent,alliance,character,constellation,corporation,faction,inventorytype,region,solarsystem,station,wormhole");
