...
namespace ESISharp.ESIPath.Character {
    ...
    public class CharacterMail {
        ...
        public EsiRequest GetHeaders(int CharacterID, long Label) {
            return GetHeaders(CharacterID, new[] { Label }, null);
        }
        ...
        public EsiRequest GetHeaders(int CharacterID, long Label, int LastMailID) {
            return GetHeaders(CharacterID, new[] { Label }, LastMailID);
        }
        ...
        /// <returns>EsiRequest</returns>
        public EsiRequest SendNew(int CharacterID, string MailBody, string MailSubject, int RecipientID,
        ...
        /// <returns>EsiRequest</returns>
        public EsiRequest SendNew(int CharacterID, string MailBody, string MailSubject,
            List<Recipient> MailRecipients) {
        ...
        public EsiRequest SendNew(int CharacterID, EveMail Mail) {
            ...
            var Data = new {
                ...
                recipients = Mail.Recipients
                    .Select(r => new { recipient_id = r.RecipientID, recipient_type = r.RecipientType }).ToArray(),
