...
namespace ESISharp.ESIPath {
    ...
    public class CorporationMain {
        ...
        public EsiRequest GetNames(long CorporationID) {
            return GetNames(new[] { CorporationID });
        }
    ...
    public class AuthCorporationMain : CorporationMain {
        ...
        /// <summary>
        ///     Get Corporation's Member Status, including Character ID, Location, Last Logoff and Logon, Current Ship Type,
        ///     and Start Date.
        /// </summary>
        ...
        /// <returns>EsiRequest</returns>
        public EsiRequest UpdateStructureVulnerabilitySchedule(int CorporationID, long StructureID,
            IEnumerable<StructureVulnerabilityPeriod> Periods) {
