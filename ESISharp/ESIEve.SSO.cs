...
namespace ESISharp {
    ...
    public partial class Sso {
        ...
        public void AddScope(Scope NewScope) {
            ...
            var LocalAuthorizedScopes = AuthorizedScopes;
        ...
        public void AddScope(IEnumerable<Scope> NewScopes) {
            foreach (var NewScope in NewScopes) AddScope(NewScope);
        }
        ...
        public void RemoveScope(IEnumerable<Scope> OldScopes) {
            foreach (var OldScope in OldScopes) RemoveScope(OldScope);
        }
        ...
        public bool ForceAuthorization() {
            while (VerifyCredentials()) return (AuthToken != null || ImplicitToken != null) && IsTokenValid();
            return false;
        }
    }
